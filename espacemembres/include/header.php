...
<div><nav class="navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="index.php">Accueil</a>
          <ul class="navbar-nav navbar-right">
              <li class="nav-item"><a class="nav-link " href="gardiennes.php">Gardiennes</a></li>
              <li class="nav-item"><a class="nav-link " href="niveaux.php">Niveaux</a></li>
              <li class="nav-item"><a class="nav-link " href="commentaires.php">Faire un commentaire</a></li>
          </ul>
